...
import { cn } from "@/lib/utils"; // ← add this if you use shadcn utils
...
export default function AdminGalleryModal({ isOpen, onClose }: AdminGalleryModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.title || !formData.beforeImage || !formData.afterImage) {
      toast({ title: "Missing fields", description: "Title and both images are required", variant: "destructive" });
      return;
    }
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[92vh] overflow-y-auto p-0 gap-0 bg-gradient-to-b from-gray-50/80 to-white">
        <DialogHeader className="px-6 pt-6 pb-4 border-b bg-white/80 backdrop-blur-sm sticky top-0 z-10">
          <DialogTitle className="text-2xl font-bold tracking-tight text-gray-900">
            Before & After Gallery
          </DialogTitle>
          <p className="text-sm text-gray-500 mt-1">Manage transformation showcase</p>
        </DialogHeader>
        ...
        <div className="px-6 py-6 space-y-8">
                ...
                >
                    ...
                    {(["before", "after"] as const).map((type) => (
                      <div key={type} className="space-y-2">
                        ...
                        {formData[`${type}Image` as keyof typeof formData] ? (
                          ...
                          <label className="flex flex-col items-center justify-center aspect-video border-2 border-dashed border-gray-300 rounded-xl cursor-pointer hover:border-blue-400 hover:bg-blue-50/40 transition-all">
                  ...
                  <div className="flex justify-end pt-4">
                    <Button
                      ...
                      className="min-w-40 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700"
                    >
          ...
          <div className="space-y-4">
            ...
            {isLoading ? (
              ...
              <div className="border border-dashed rounded-2xl p-12 text-center text-gray-500 bg-gray-50/60">
              ...
              <div className="space-y-3">
                {images.map((img, idx) => (
                  <motion.div
                    ...
                    className={cn(
                      "group flex items-center gap-4 p-4 bg-white border rounded-xl shadow-sm hover:shadow transition-all",
                      !img.isActive && "opacity-65 bg-gray-50/70 border-gray-200"
                    )}
                  >
                    ...
                    <div className="flex items-center gap-2 opacity-90 group-hover:opacity-100 transition-opacity">
                      ...
                      <Button
                        ...
                        className={cn(
                          "h-9 w-9",
                          img.isActive ? "text-emerald-600 hover:text-emerald-700" : "text-gray-500 hover:text-gray-700"
                        )}
                      >
